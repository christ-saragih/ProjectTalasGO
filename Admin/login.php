...
<head>
    ...
    <title><?php echo $language["Login"]; ?> | TalasGO - Admin</title>
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index.php" class="d-block auth-logo">
                                    <img src="assets/images/logo talasgo terbaru.png" alt="" height="40"> <span class="logo-txt"></span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Selamat datang kembali!👋</h5>
                                    <p class="text-muted mt-2">Masuk untuk melanjutkan ke Admin TalasGO
                                </div>
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Belum memiliki akun? <a href="register.php" class="text-primary fw-semibold"> Daftar sekarang </a> </p>
                                </div>
                            </div>
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                        document.write(new Date().getFullYear())
                                    </script> TalasGO . Created by Xtreme Squad</p>
                            </div>
                        </div>
                    </div>
                </div>
